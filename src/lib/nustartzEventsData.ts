...
export const nuStartzEventsData: NuStartzEventsDataType[] = [
  {
    ...
    capturedEventImage: `${IMAGES.nustartzEvent1Image1}`,
    conclusionText:
  ...
  },
  {
    ...
    eventTitle: "Moments",
    eventImages: [`${IMAGES.nustartzEvent2Image2}`],
    content:
    ...
    capturedEventImage: `${IMAGES.nustartzEvent2Image1}`,
  },
  {
